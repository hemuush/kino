  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="url(#kino-play-grad)"
        stroke="url(#kino-play-grad)"
        strokeWidth="1"
        strokeLinejoin="round"
      />
      
      <defs>
        <linearGradient id="kino-lens-grad" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3b82f6" />
          <stop offset="0.5" stopColor="#00f0ff" />
          <stop offset="1" stopColor="#8b5cf6" />
        </linearGradient>
        <linearGradient id="kino-shutter-grad" x1="2" y1="2" x2="22" y2="22" gradientUnits="userSpaceOnUse">
          <stop stopColor="#3b82f6" />
          <stop offset="1" stopColor="#00f0ff" />
        </linearGradient>
        <linearGradient id="kino-play-grad" x1="10" y1="7" x2="16" y2="15" gradientUnits="userSpaceOnUse">
